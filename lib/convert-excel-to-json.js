...
const excelToJson = (function() {
    ...
    const parseSheet = (sheetData, workbook) => {
        ...
        for (let cell in sheet) {
            ...
            if (cell == '!ref' || (!_config.sheetStubs && sheet[cell].v === undefined)) {
                continue;
            }
            ...
            if (dataVariables) {
                dataVariables.forEach(dataVariable => {
                    ...
                    switch (dataVariableRef) {
                        ...
                        default:
                            variableValue = getSheetCellValue(sheet[dataVariableRef]) || null;
                    }
            ...
            rowData[columnData] = getSheetCellValue(sheet[cell]) || null;
